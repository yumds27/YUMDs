const icons = {
  ...
  filePdf: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M9 13h1.5a1 1 0 0 1 0 2H9v-4h1.5a1 1 0 0 1 0 2"/><path d="M14 13v4"/><path d="M17 13h-1.5a1 1 0 0 0 0 2H17"/>
    </svg>
  ),
  fileImage: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
...
export default function Icon({ name, size = 16, className = "" }) {
  return (
    <span className={`icon ${className}`} style={{ width: size, height: size, display: "inline-flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
      {icons[name] ?? null}
    </span>
  );
}
